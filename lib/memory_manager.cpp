...
MemoryManager::createMapping(uintptr_t src,
                             uintptr_t dest,
                             size_t size,
                        ...
                        const MemoryManager::AddressSpaceId &toAddrSpaceId)
{
        ...
        if(not memoryGraph.getPath(fromAddrSpaceId,
                                   toAddrSpaceId,
                                   pathGraph,
                                   pathCheckFunc)) {

                logger->debug("No translation found from ({}) to ({})",
                              fromAddrSpace->toString(),
                              toAddrSpace->toString());
...
MemoryTranslation::operator+=(const MemoryTranslation &other)
{
        ...
        assertExcept(other.src < this_dst_high,
                     MemoryManager::InvalidTranslation());
        assertExcept(this->dst < other_src_high,
                     MemoryManager::InvalidTranslation());
