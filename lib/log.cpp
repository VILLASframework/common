...
public:
                    ...
                    spdlog::memory_buf_t &dest) override
        {
                ...
                auto lvlpad
                    = std::string(padinfo_.width_ - lvl.size(), ' ') + lvl;
...
void Log::parse(json_t *json)
{
        ...
        if(json_expressions) {
                if(!json_is_array(json_expressions))
                        throw ConfigError(json_expressions,
                                          "node-config-logging-expressions",
                                          "The 'expressions' setting must be "
                                          "a list of objects.");
